...
class SpringAIConfigurationTest {
    ...
    void chatClient_doesNotThrow() {
        ...
        AiCharacterProperties aiCharacterProperties = new AiCharacterProperties("TestAI", "Test personality");

        SpringAIConfiguration springAIConfiguration = new SpringAIConfiguration(List.of(), chatClientBuilder, chatMemory, aiCharacterProperties);
